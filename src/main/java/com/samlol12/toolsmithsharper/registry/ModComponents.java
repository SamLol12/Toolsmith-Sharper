...
public class ModComponents {
    public static final ComponentType<Integer> SHARPER_USES = Registry.register(
            Registries.DATA_COMPONENT_TYPE, Identifier.of(ToolsmithSharper.MOD_ID, "sharper_uses"), ComponentType.<Integer>builder().codec(Codec.INT).build()
    );
    public static final ComponentType<String> SHARPER_COATING = Registry.register(
            Registries.DATA_COMPONENT_TYPE, Identifier.of(ToolsmithSharper.MOD_ID, "sharper_coating"), ComponentType.<String>builder().codec(Codec.STRING).build()
    );
    public static final ComponentType<String> SHARPER_COATING_TIER = Registry.register(
            Registries.DATA_COMPONENT_TYPE, Identifier.of(ToolsmithSharper.MOD_ID, "sharper_coating_tier"), ComponentType.<String>builder().codec(Codec.STRING).build()
    );
